export default function define(runtime, observer) {
    ...
    const fileAttachments = new Map([["sol-ecosystem.json", "/sol-ecosystem.json"]]);
    ...
    main.variable(observer("data")).define("data", ["FileAttachment"], function (FileAttachment) {
        return (
            FileAttachment("sol-ecosystem.json").json()
        )
    });
    ...
    main.variable(observer("color")).define("color", ["d3", "data"], function (d3, data) {
        return (
            d3.scaleOrdinal(d3.quantize(d3.interpolateCool, data.children.length + 1))
        )
    });
